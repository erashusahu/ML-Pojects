...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            input_feature_train_data=train_path.drop(columns=[target_column_name],axis=1)
            target_feature_train_data=train_path[target_column_name]
            
            input_feature_test_data=test_path.drop(columns=[target_column_name],axis=1)
            target_feature_test_data=test_path[target_column_name]
